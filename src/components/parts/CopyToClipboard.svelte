...
<!-- uno safelist class="tooltip-open tooltip-success tooltip-error" -->
<div
  class="mb-2 tooltip tooltip-bottom before:mt-0.8 after:mt-1 hover:before:opacity-80 hover:after:opacity-80"
