...
<div class="flex my-0.5">
  <div class="grow" />
  <Bits bind:integer multipleOf={lengthOfBits} {max} {borderOctal} {borderHex} {overrideCellBg} />
</div>
<div class="flex my-0.5">
  <div class="grow" />
  <Digits bind:integer {lengthOfBits} max={max / 4} drawBorder={borderHex} {overrideCellBg} />
</div>
